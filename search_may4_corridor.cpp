...
int main() {
    try {
        ...
        // Barbara path on May 4 (JD 2461164.5 to 2461165.5)
        // From check_barbara_path output:
        ...
        q.width = astrometry::Angle::from_arcsec(60.0); // 1 arcminute width
        q.max_magnitude = 16.5;
        
        cout << "Querying Gaia corridor for May 4 path..." << endl;
        auto stars = catalog::GaiaDR3Catalog::instance().query_corridor(q);
        cout << "Found " << stars.size() << " stars in 1-arcmin corridor." << endl;

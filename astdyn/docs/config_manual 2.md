...
- `file` (string): Absolute path to the JPL `.bsp` file (uses native stateless reader).
- `asteroid_file` (string): Path to a `.bsp` containing asteroid ephemerides.
...
---
*Generated by AstDyn System - 2026-03-17*

...
\title{\textbf{AstDyn: A High-Fidelity C++ Library for Asteroid Dynamics and Occultation Prediction}}

\author{M. Bigi$^{1}$\thanks{Contact: michele.bigi@example.com} \\
\small $^{1}$Independent Researcher, Italy}

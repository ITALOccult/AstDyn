...
\usepackage[paperwidth=12.926in, paperheight=9.25in, margin=0mm]{geometry}
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \begin{scope}[shift={(current page.south west)}, x=1mm, y=1mm]
        ...
        % --- STAR FIELD ---
        \foreach \i in {1,...,150} {
             \fill[white, opacity=0.4] ({random(5,323)}, {random(5,230)}) circle ({0.1+random(0,2)/10});
        }

        % ==========================================================================================
        % FRONT COVER (Right Side) - Center X = 248.95 mm
        % ==========================================================================================
        
        % Title Block
        \node[anchor=north, align=center] at (248.95, 210) {
        ...
        % Graphics
        \begin{scope}[shift={(248.95, 95)}, scale=10.0]
        ...
        % Bottom Info
        \node[anchor=south west, text width=80mm] at (26, 15) {
            \color{white!60}

...
\begin{tikzpicture}[scale=1.0]
    % Fundamental plane (equator) - Standardized size
    \draw[thick,blue!30,fill=blue!5] (0,0) ellipse (2.5cm and 0.8cm);
    \node[blue] at (2.5,0.4) {Equator};
    ...
    \draw[->,thick,red] (0,0) -- (3.0,0);
    \node[red,right] at (3.0,0) {$\mathbf{X}$ (to $\gamma$)};
    ...
    % Z-axis (toward NCP)
    \draw[->,thick,blue] (0,0) -- (-1.2,2.2);
    \node[blue,left] at (-1.2,2.2) {$\mathbf{Z}$ (NCP)};
    
    % Vernal equinox symbol
    \node[red] at (2.7,-0.2) {$\gamma$};
    
    % Celestial object
    \filldraw[orange] (1.8,1.5) circle (3pt);
    \draw[->,dashed] (0,0) -- (1.8,1.5);
    \node[orange,right] at (1.8,1.5) {Celestial object};
    
    % Right ascension arc
    \draw[->,purple] (0.8,0) arc (0:40:0.8);
    \node[purple] at (1.0,0.3) {$\alpha$};
    
    % Declination arc
    \draw[->,purple] (1.3,0) -- (1.3,1.1);
    \node[purple,right] at (1.3,0.6) {$\delta$};
\end{tikzpicture}

...
\section{Outlier Handling (High Chi-Squared)}
...
\begin{equation}
\begin{split}
    r_{\parallel} &= \Delta\alpha \cos\delta \cos\theta \\
                  &\quad + \Delta\delta \sin\theta
\end{split}
\end{equation}
\begin{equation}
\begin{split}
    r_{\perp} &= -\Delta\alpha \cos\delta \sin\theta \\
              &\quad + \Delta\delta \cos\theta
\end{split}
\end{equation}
    ...
    const EphemerisInterface& ephemeris)
{
    ...
    for (size_t i = 0; i < obs.size(); ++i) {
        ...
        Vector2d computed = predict_observation(y_obs, 
                                              obs[i].epoch, 
                                              obs[i].obs_code, 
                                              ephemeris);
...
\subsection{\texorpdfstring{When $\chi^2_{\text{red}} \gg 1$}{When Chi-Square is Large}}

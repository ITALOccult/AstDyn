...
The residuals (AstDyn - JPL) are shown in Figure~\ref{fig:residuals_precision}. The agreement is excellent: the maximum position error over the entire decade is below $2.5 \times 10^{-9}$ AU ($\approx 3.7$ meters).

...
\subsection{Results}
The position residuals are shown in Figure~\ref{fig:residuals_val_accuracy}. The maximum position error over the 10-year integration arc remains below $2.5 \times 10^{-9}$ AU (approximately 3 meters), well within the requirements for occultation prediction (typically $\sim 10$ km accuracy).

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{residual_plot.pdf}
    ...
    \label{fig:residuals_val_accuracy}
\end{figure}

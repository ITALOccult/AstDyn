...
\textbf{Principle}: Arc should span $\geq 3^\circ$ of sky motion for good orbit determination.
...
\begin{itemize}
    \item \textbf{\path{de440s.bsp}}: 1849-2150, 18 MB (recommended)
    \item \textbf{\path{de440.bsp}}: 1550-2650, 115 MB (extended)
    \item \textbf{\path{de441.bsp}}: -13200-17191, 302 MB (research)
\end{itemize}

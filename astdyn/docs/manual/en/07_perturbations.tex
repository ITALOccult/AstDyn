...
\begin{lstlisting}[language=C++,caption={Configuring the Force Model in AstDyn}]
...
settings.include_sun_j2 = true;
settings.ppn_beta = 1.0;
settings.ppn_gamma = 1.0;

// Initialize ephemeris and force field
auto ephem = std::make_shared<PlanetaryEphemeris>("de441.bsp");
ForceField field(settings, ephem);

// Use in propagation
Propagator prop(settings, field);

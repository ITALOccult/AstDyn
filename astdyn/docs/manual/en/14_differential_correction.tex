...
Combine geometric partials with $\Phi$:

\begin{equation}
    \mathbf{H}_i = \begin{bmatrix}
        \frac{\partial \alpha}{\partial x} & \frac{\partial \alpha}{\partial y} & \frac{\partial \alpha}{\partial z} & 0 & 0 & 0 \\
        \frac{\partial \delta}{\partial x} & \frac{\partial \delta}{\partial y} & \frac{\partial \delta}{\partial z} & 0 & 0 & 0
    \end{bmatrix} \Phi(t_i, t_0)
\end{equation}

...
\begin{lstlisting}[language=C++,caption={STM propagation}]
...
prop.enable_stm(true);  // Enable STM computation

// Propagate state and STM
auto result = prop.propagate_with_stm(y0, t0, tf);

Vector6d yf = result.state;
Matrix6d Phi = result.stm;  // 6x6 state transition matrix

std::cout << "STM determinant: " << Phi.determinant() << "\n";
std::cout << "STM condition number: " 

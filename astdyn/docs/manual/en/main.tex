...
\lstdefinestyle{output}{
    backgroundcolor=\color{white},   % Sfondo bianco per l'output
    basicstyle=\ttfamily\small\setstretch{1.0},
    numbers=none,                    % Rimuove i numeri di riga per l'output
    frame=single,                    % Cornice semplice
    rulecolor=\color{gray},          % Cornice grigia leggera
    keywordstyle=\color{black},      % Nessuna evidenziazione sintattica
    commentstyle=\color{black},
    stringstyle=\color{black},
    showstringspaces=false,
    breaklines=true,
    literate={_}{\_}{1}              % Protegge eventuali underscore nell'output
}
...
% Definizioni matematiche custom
...
\include{18_library_types}
\include{19_parsers}
\include{20_api_reference}
\include{21_examples}
\include{22_asteroid_fitter_json}

% Part V: Validation and Testing
\part{Validation and Applications}
\include{18_validation_results}
\include{21_validation}
\include{22_case_studies}
\include{23_performance}
\include{23_high_precision_workflow}

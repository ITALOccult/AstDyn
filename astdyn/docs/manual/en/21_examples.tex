...
\begin{lstlisting}[language=C++, caption={example1\_propagation.cpp}, mathescape=false]
...
Perform a massive search for occultations by asteroids (1000) through (1050) using Gaia DR3 stars, filtering for high-quality events (RUWE < 1.4, Moon distance $> 30^\circ$).

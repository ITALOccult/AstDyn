...
\usepackage[paperwidth=6in, paperheight=9in, 
            ...
            inner=2.3cm, outer=1.3cm, 
            headheight=15pt, footskip=1.0cm]{geometry}
...
% Line spacing - slightly tighter for 6x9
\usepackage{setspace}
\setstretch{1.15}
...
\lstset{
    ...
    basicstyle=\ttfamily\scriptsize, % Smaller font for code in 6x9
    ...
    tabsize=2, % Smaller tab for narrower pages
    captionpos=b,
    breaklines=true,

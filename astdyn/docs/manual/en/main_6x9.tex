...
\usepackage[paperwidth=6in, paperheight=9in, 
            ...
            inner=1.15in, outer=0.5in, 
            headheight=28pt, headsep=15pt, footskip=0.5in]{geometry}
...
\lstset{
    ...
    basicstyle=\ttfamily\tiny\setstretch{1.0}, % Tiny font + single space to prevent overflow
    ...
    captionpos=b,
    breaklines=true,
    breakatwhitespace=false, % Allow breaking anywhere to prevent overflow
    escapeinside={\%*}{*)},
    xleftmargin=0.5em,
    xrightmargin=0.0em
}
